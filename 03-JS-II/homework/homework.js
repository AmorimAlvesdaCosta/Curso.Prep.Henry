...
function saludo(idioma) {
  ...
  // Tu código:
  var resultado
  if(idioma==='aleman') resultado = 'Guten Tag!'
   else if(idioma==='mandarin') resultado = 'Ni Hao!'
    else if(idioma==='ingles') resultado = 'Hello!'
     else resultado = 'Hola!'
...
var solucion
  if(numero%3===0 && numero%5===0) solucion = 'fizzbuzz'
    else if(numero%5===0) solucion = 'buzz'
      else if(numero%3===0) solucion = 'fizz' 
        else solucion = numero

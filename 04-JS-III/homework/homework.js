...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
          ...
          //if(i > 18) arreglo.push 

  var elemento = 0

  for(var i = 0 ; i<arreglo.length ; i++)
  if(arreglo[i] > 18) elemento++
...
function mesesDelAño(array) {
  ...
  for(var i = 0 ; i < array.length ; i++)
    ...
    TablaMeses.push(array[i])
  if(TablaMeses.length<3) return 'No se encontraron los meses pedidos'
  else return TablaMeses
}
